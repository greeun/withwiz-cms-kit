import { validateImageSize, resizeImageIfNeeded } from '@withwiz/cms-kit/utils/image-resize';
...
describe('validateImageSize', () => {
  ...
  it('CMS-IR-02: GIF 5MB 초과 → 에러 메시지', () => {
...
describe('resizeImageIfNeeded', () => {
  it('CMS-IR-04: GIF → wasResized=false', async () => {
  ...
  it('CMS-IR-05: 500KB 이하 + 작은 이미지 → 리사이즈 스킵', async () => {
