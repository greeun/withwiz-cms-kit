...
vi.mock('@withwiz/cms-kit/infrastructure/prisma', () => ({
  prisma: {},
}));
...
vi.mock('@withwiz/cms-kit/utils/r2-helpers', () => ({
  collectR2Keys: vi.fn(() => []),
  deleteR2Keys: vi.fn(),
}));
