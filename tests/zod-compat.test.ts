...
import { slugSchema, optionalUrlSchema } from '@withwiz/cms-kit/validators/shared';

/**
 * CMS-ZC — Zod peer-range ↔ source mutual consistency (spec.md §4.7 / Z1 /
 * AC-4.7.1).
 *
 ...
 * source rewrite, so CMS-SV-01..12 stay byte-identical and pass unchanged.
 */
...
describe('zod compat (CMS-ZC)', () => {
  it('CMS-ZC-01: peerDependencies.zod admits 4.4.3 and NONE of Zod 3.x', () => {
  ...
  it('CMS-ZC-02: slugSchema accepts valid, rejects invalid (installed Zod)', () => {
  ...
  it('CMS-ZC-03: optionalUrlSchema accepts https + empty/undefined', () => {
  ...
  it('CMS-ZC-04: optionalUrlSchema REJECTS file:/javascript:/data: protocols', () => {
    expect(
